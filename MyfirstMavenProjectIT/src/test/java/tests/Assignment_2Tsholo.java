...
public class Assignment_3Tsholo {
	...
	// Test Case 3
		...
		//*****Table code from Louise*******
					
					public void ApprovedTariffPlan_tabless() throws IOException {
						//sfSelenium.createTest("Run Test: Tables");
										
				//Element for entire table =>>////form[@action='inserttariffplantocustomer.php']/div[@class='table-wrapper']
					   ...
					   String tablexpath = "//table/tbody";
				        ...
				        System.out.println("Total Number of colums in row 5: "+TotalColsList.size());
				       
				        for (WebElement webElement : TotalColsList){
				            String item = webElement.getText();
				            System.out.println(item);
				        }
				       
				        // Look at field values
				        WebElement ToGetFieldValues = driver.findElement(By.xpath("//tbody/tr[3]/td[2]"));
