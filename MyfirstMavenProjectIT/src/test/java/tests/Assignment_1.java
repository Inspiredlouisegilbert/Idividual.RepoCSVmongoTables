...
@AfterSuite
	 ...
	 * 
	 * // landingPage.searchProduct(); String expected = "Printed Summer Dress"; //
	 ...
	 * 
	 * boolean expected = true; boolean actual =
	 * inPage.verifyInCorrectLogin().equals("AUTHENTICATION");
	 * 
	...
	/*
	 * //@Test public void GIVEN_navigateToURL_THEN_ExpectedTofail() { String
	 * expectedTitle = "My St";
	 * Reporter.log("expected ------------------"+expectedTitle); String actualTitle
	 ...
	 * }
	 * 
	 * @Parameters({"xyz"}) //@Test public void
	 * Use_Parameters_from_testng_XML_file(String xyz) {
	 * Reporter.log("This parameter comes from the testNG xml file: "+xyz); }
	 * 
	 * //@Test public void Use_utilities() { String browserValue =
	 * landingPage.getDataConfigProperties("browser");
	 * Reporter.log("The browser we are using is "+browserValue); }
	 * 
	 * @AfterSuite public void cleanup() {
	 * 
	 * //Instantiate SignInPage class object SignInPage inPage = new SignInPage();
	 * inPage.cleanUp(); } }
	 */